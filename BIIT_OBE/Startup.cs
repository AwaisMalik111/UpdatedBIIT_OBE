using BIIT_OBE_Infrastructure.Implementation.UserAuthentication;
using BIIT_OBE_Infrastructure.Implementation.Program;
...
using BIIT_OBE_Infrastructure.Implementation.Course;
using BIIT_OBE_Infrastructure.Interfaces.Weightage;
using BIIT_OBE_Infrastructure.Implementation.Weightage;
using BIIT_OBE_Infrastructure.Interfaces.Result;
using BIIT_OBE_Infrastructure.Implementation.Result;
...
namespace BIIT_OBE
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddTransient<IPrograms,Programs>();
            services.AddTransient<ICourse,Course>();
            services.AddTransient<IWeightage, Weightage>();
